...
export const global = {
  ...
  /** 投影-控件-B1 */
  '--shadow-control-b1': "0 0 1px 0 rgba(0, 1, 3, 20%), 0 1.5px 4px -1px rgba(0, 1, 3, 4%)",
  /** 投影-控件-L1 */
  '--shadow-control-l1': "0 0 1px 0 rgba(0, 1, 3, 5%), 0 2px 7px 0 rgba(0, 1, 3, 5%),",
  /** 投影-卡片-L1 */
  '--shadow-card-l1': "0px 1.5px 2px -1px rgba(0, 19, 41, 0.07)",
  /** 投影-气泡-L2 .shadow-hover-control-l2---》shadow-bubble-l2 */
  '--shadow-hover-control-l2': "0 0 1px 0 rgba(0, 1, 3, 5%), 0 6px 16px 0 rgba(0, 1, 3, 8%)",
  /** 投影-弹窗-L3 */
